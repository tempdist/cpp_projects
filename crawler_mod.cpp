 ...
 *
 * To compile:
 *   gcc crawler_mod.cpp $(pkg-config --cflags --libs libxml-2.0 libcurl)
 *
 */
/* <DESC>
...
#endif
//std::cout << "Enter the start page to crawl: ";
// char * start_page = argv[1]; 
// std::cout << "Crawling from start page "<<start_page<<endl;
